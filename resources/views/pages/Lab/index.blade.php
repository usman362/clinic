                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover dt-responsive dataTable no-footer dtr-column" id="appointment" role="grid" style="width: 100%;">
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th class="all sorting" tabindex="0" aria-controls="appointment" rowspan="1" colspan="1" aria-label="Hospital Name: activate to sort column ascending" style="width: 112px;">Laboratory Name</th>
