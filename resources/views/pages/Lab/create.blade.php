...
<div class="content-wrapper" style="min-height: 948px;">
    ...
    <h4>Create Laboratory</h4>
    </div>
    </div>
    <div class="panel-body">
    <div class="portlet-body form">
    <form action="{{URL::to('Laboratory')}}" class="form-horizontal" target="_blank" name="p_info" method="post" accept-charset="utf-8">
        @csrf
