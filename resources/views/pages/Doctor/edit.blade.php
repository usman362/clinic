...
<div class="content-wrapper" style="min-height: 948px;">
    ...
    <form action="{{URL::to('Doctor',$doctor->id)}}" class="form-horizontal" name="d_info" role="form" enctype="multipart/form-data" method="post" accept-charset="utf-8">
        @csrf
        @method('PUT')
    ...
    <div class="col-md-7">
    <input type="text" name="name" class="form-control" value="<?php echo Crypt::decryptString($doctor->name)?>" placeholder="Doctor Name" required="">
    </div>
    </div>
    <div class="form-group">
    <label class="col-md-3 control-label"><span class="text-danger">*</span>Email Address </label>
    <div class="col-md-7">
    <input type="email" name="email" class="form-control"  value="<?php echo Crypt::decryptString($doctor->email)?>" placeholder="Email Address" required="">
    </div>
    </div>
    <div class="form-group">
    ...
    <div class="col-md-7">
    <input type="text" name="designation" class="form-control"  value="<?php echo Crypt::decryptString($doctor->designation)?>" placeholder="Designation">
    </div>
    </div>
    <div class="form-group">
    <label class="col-md-3 control-label">Degrees</label>
    <div class="col-md-7">
    <input type="text" name="degrees" class="form-control"  value="<?php echo Crypt::decryptString($doctor->degrees)?>" placeholder="Degrees" required="">
    </div>
    </div>
    <div class="form-group">
    <label class="col-md-3 control-label"><span class="text-danger">*</span> Department </label>
    <div class="col-md-7">
    <input type="text" name="department" class="form-control"  value="<?php echo Crypt::decryptString($doctor->department)?>" placeholder="Department" required="">
    </div>
    </div>
    <div class="form-group">
    <label class="col-md-3 control-label"><span class="text-danger">*</span>Specialist</label>
    <div class="col-md-7">
    <input type="text" name="special" class="form-control"  value="<?php echo Crypt::decryptString($doctor->special)?>" placeholder="Specialist" required="">
    </div>
    </div>
    <div class="form-group">
    <label class="col-md-3 control-label">Doctor Experience</label>
    <div class="col-md-7">
    <input type="text" name="experience" class="form-control"  value="<?php echo Crypt::decryptString($doctor->experience)?>" placeholder="Doctor Experience">
    </div>
    </div>
    <div class="form-group">
    <label class="col-md-3 control-label"><span class="text-danger">*</span>Service Place</label>
    <div class="col-md-7">
    <input type="text" name="service" class="form-control"  value="<?php echo Crypt::decryptString($doctor->service)?>" placeholder="Service Place" required="">
    </div>
    </div>
    <div class="form-group">
    <label class="col-md-3 control-label">Birth date</label>
    <div class="col-md-7">
    <input type="date"  name="birth" class="form-control datepicker1 hasDatepicker"  value="<?php echo Crypt::decryptString($doctor->birth)?>" placeholder="yyyy-mm-dd" >
    </div>
    </div>
    <div class="form-group">
    <label class="col-md-3 control-label"><span class="text-danger">*</span>Phone Number</label>
    <div class="col-md-7">
    <input type="number" name="phone" class="form-control"  value="<?php echo Crypt::decryptString($doctor->phone)?>" placeholder="Phone Number" required="">
    </div>
    </div>
    <div class="form-group">
